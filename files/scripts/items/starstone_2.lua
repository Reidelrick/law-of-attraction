...
-- thank you horscht for helping me understand this math
...
if is_in_camera_bounds(x,y,250) then
	function calculate_force_at(body_x, body_y)
		...
		if distance < 12 then
			-- stop repelling when near enough to prevent some collisions against moon
			return 0,0
		end
	...
	function calculate_force_for_body( entity, body_mass, body_x, body_y, body_vel_x, body_vel_y, body_vel_angular )
		...
		fx = fx * 0.11 * body_mass * 10
		fy = fy * 0.11 * body_mass * 10
